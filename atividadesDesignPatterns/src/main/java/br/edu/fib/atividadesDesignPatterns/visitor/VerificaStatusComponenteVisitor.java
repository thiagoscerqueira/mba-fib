...
/**
 * Classe que implementa a visitação de cada um dos componentes para a ação de
 * verificação de status. cada um dos métodos "visitar" recebe como parâmetro o
...
public class VerificaStatusComponenteVisitor implements IPerifericoVisitor {
	...
	public void visitar(Impressora impressora) {
		System.out.println("Impressora pronta");
	}
